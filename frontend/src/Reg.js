...
export default function Reg() {
    ...
    const handleclick1 = () => {
        if (dob == "" || regemail == "" || regpw == "") {
            alert("All fields are mandatory !")
        }
        else {
            let url = "http://localhost:8000/Register2"
            let request = { dtdob: dob, txtEmail: regemail, txtPassword: regpw }
            let header = {};
    ...
    return <>
        ...
        <div className="register_row2">
            <label style={{ fontSize: 30 }}>Great! You have completed <b>20%</b></label>
        </div>
